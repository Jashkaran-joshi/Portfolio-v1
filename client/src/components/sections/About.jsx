...
export default function About() {
  ...
  return (
    ...
    <section id="about" className="section-spacing relative overflow-hidden scroll-mt-20">
          ...
          <div className="flex flex-col justify-center space-y-4 md:space-y-5 lg:space-y-7">
            ...
            <Reveal>
              ...
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-2 md:mb-3">
                ...
                I'm <span className="text-neon">Jaskaran Joshi</span> – Python Developer, Security Analyst & Full Stack Engineer
            ...
            <Reveal delay={0.2}>
              ...
              <p className="text-white/70 leading-relaxed text-sm sm:text-base">
                ...
                I build production-grade applications with Python and modern JavaScript frameworks, then stress-test them the way an attacker would. From writing Django backends to running penetration tests with Burp Suite, I operate at the intersection of development and security — because the best time to fix a vulnerability is before it ships.
