...
const SkillBar = memo(function SkillBar({ label, value, index, shouldReduceMotion }) {
    ...
    <div className="group">
      ...
      <div className="w-full bg-white/5 rounded-full h-1.5 sm:h-2 overflow-hidden relative">
        ...
        <motion.div
          ...
          whileInView={shouldReduceMotion ? undefined : { width: `${value}%` }}

          viewport={{ once: true }}

          transition={{ duration: shouldReduceMotion ? 0 : 1.2, ease: [0.16, 1, 0.3, 1], delay: index * 0.08 }}
...
const SkillTag = memo(function SkillTag({ item, delay, shouldReduceMotion }) {

  return (

    <motion.span

      className="px-3 py-1.5 md:px-4 md:py-2 bg-white/5 border border-white/10 rounded-lg text-xs md:text-sm text-white/70 hover:border-neon hover:text-white hover:bg-neon/10 transition-all duration-300 cursor-default hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(0,243,255,0.3)]"
      ...
      transition={{ duration: 0.3, delay: shouldReduceMotion ? 0 : delay }}
...
export default function Skills() {
  ...
  return (
    ...
    <section id="skills" className="section-spacing relative overflow-hidden scroll-mt-20">
      ...
      <div className="container-custom relative z-10">
        ...
        <SectionHeading
          ...
          subtitle="Python development, offensive security tooling, and full-stack engineering — the skills I use to build and break things."
        ...
        <div className="mt-10 md:mt-14 lg:mt-16 grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-4 md:space-y-6 order-2 lg:order-1">
            ...
            {personalData.skills.map((group, index) => (
              ...
              <Reveal key={index} delay={index * 0.08} width="100%">
                ...
                <GlassCard className="p-5 md:p-6 border-l-4 border-l-neon/50 h-full group" isoColor="#00f3ff">
                  ...
                  <div className="flex flex-wrap gap-2 md:gap-3">
                    ...
                    {group.items.map((item, i) => (
                      ...
                      <SkillTag key={item} item={item} delay={i * 0.03} shouldReduceMotion={shouldReduceMotion} />
          ...
          <div className="order-1 lg:order-2 lg:sticky lg:top-24">
            ...
            <Reveal width="100%" delay={0.1}>
              ...
              <GlassCard className="p-5 md:p-6 group" isoColor="#a855f7">
                ...
                <div className="space-y-4 md:space-y-5 lg:space-y-6">
                  ...
                  {personalData.skillProgress.map((skill, index) => (
                    ...
                    <SkillBar key={index} label={skill.label} value={skill.value} index={index} shouldReduceMotion={shouldReduceMotion} />
